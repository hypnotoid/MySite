insert into mysite.items (amount, name, orders, price)
values (20, 'The Tartar Sauce', 42, 89);
insert into mysite.items (amount, name, orders, price)
values (89, 'STAPLER', 7, 85);
insert into mysite.items (amount, name, orders, price)
values (14, 'Book', 3, 75);
...
insert into mysite.roles (name)
values ('ROLE_USER'); -- 2 is USER
insert into mysite.roles (name)
values ('ROLE_EDITOR'); -- 3 is EDITOR

insert into mysite.users_roles (user_id, role_id)
VALUES (1, 1); -- user admin has role admin
insert into mysite.users_roles (user_id, role_id)
VALUES (1, 3); -- user admin has role editor

insert into mysite.users_roles (user_id, role_id)
VALUES (2, 1); -- user test has role admin
insert into mysite.users_roles (user_id, role_id)
VALUES (2, 2); -- user test has role user
insert into mysite.users_roles (user_id, role_id)
VALUES (2, 3); -- user test has role editor
